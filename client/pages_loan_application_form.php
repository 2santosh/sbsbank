...
if (isset($_POST['submit'])) {
    ...
    $stmt->bind_param('issssssssss', $client_id, $tr_code, $client_name, $loan_amount, $interest_rate, $start_date, $end_date, $status, $created_at, $loan_document, $loan_type, $deposit_document);
    if ($stmt->execute()) {
