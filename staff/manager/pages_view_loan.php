                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 form-group">
                                                ...
                                                <select name="loan_type" class="form-control" id="exampleInputPassword1">
                                                    <?php
                                                    // Fetch loan types from the database
                                                    $loan_types_query = "SELECT * FROM loan_type";
                                                    $loan_types_result = $mysqli->query($loan_types_query);

                                                    // Check if there are any loan types
                                                    if ($loan_types_result && $loan_types_result->num_rows > 0) {
                                                        while ($loan_type_row = $loan_types_result->fetch_assoc()) {
                                                            $type_id = $loan_type_row['id'];
                                                            $type_name = $loan_type_row['type'];
                                                            // Check if this loan type matches the one in the loan record
                                                            $selected = ($type_name == $row->loan_type) ? 'selected' : '';
                                                            echo "<option value='$type_id' $selected>$type_name</option>";
                                                        }
                                                    } else {
                                                        // If no loan types found, display a default option
                                                        echo "<option value='0'>No Loan Types Available</option>";
                                                    }
                                                    ?>
                                                </select>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 form-group">
                                                <label for="exampleInputPassword1">Total Amout due</label>
