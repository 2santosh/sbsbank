...
if (isset($_POST['updateStatus'])) {
    $id = intval($_POST['id']);
    $status = $_POST['status'];
    $update_query = "UPDATE iB_password_resets SET status = ?, position='csd' WHERE id = ?";
                            ...
                            <div class="card-body">
                                <table id="example1" class="table table-hover table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        $user = "client"; // Change this to the position you want to filter by
                                        $ret = "SELECT * FROM iB_password_resets WHERE user = ?";
