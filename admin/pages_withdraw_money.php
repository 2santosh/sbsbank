...
if (isset($_POST['withdrawal'])) {
    ...
    $balance_stmt->bind_result($acc_amount);
    $balance_stmt->fetch();
    $balance_stmt->close();

    // Check if the withdrawal amount is valid
    if ($transaction_amt > $acc_amount) {
        $err = "Insufficient funds. Your account balance is RS $acc_amount";
    } else {
        ...
        $stmt->bind_param('sssssssssssss', $tr_code, $account_id, $acc_name, $account_number, $acc_type, $new_balance, $tr_type, $tr_status, $client_id, $client_name, $client_national_id, $transaction_amt, $client_phone);
        $stmt->execute();
                                    ...
                                    <form method="post" enctype="multipart/form-data" role="form">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <!-- Inside your HTML form, add a box to display the account balance -->
                                                <div class="col-md-6 form-group">
