...
if (isset($_POST['systemSettings'])) {
  ...
  if (!$error) {
    ...
    move_uploaded_file($_FILES["sys_logo"]["tmp_name"], "../img/" . $_FILES["sys_logo"]["name"]);
                        ...
                        <div class="form-group col-md-12">
                          ...
                          <div class="input-group">
                            <div class="custom-file">
                              <input required name="sys_logo" id="sys_logo" type="file" class="custom-file-input" onchange="updateFileName(this)">
