<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  while ($row = $res->fetch_object()) {
    ...
    if ($row->profile_pic == '') {
      $profile_picture = "<img src='./../img/user_icon.png' class='img-circle elevation-2' alt='User Image'>
                ";
    } else {
      $profile_picture = "<img src='./../img/$row->profile_pic' class='img-circle elevation-2' alt='User Image'>
                ";
    }
  ...
  ?>
      ...
      <a href="pages_dashboard.php" class="brand-link">
        <img src="./../img/<?php echo $sys->sys_logo; ?>" alt=" Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
            ...
            <nav class="mt-2">
              <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview">
                  ...
                  <ul class="nav nav-treeview"> <!-- Added ul element here -->
                    <!-- Apply Loan -->
                    <li class="nav-item">
                    ...
                    <!-- Pending Loans -->
                    <li class="nav-item">
                      <a href="pages_manage_loans.php" class="nav-link">
          ...
          ./Statements -->
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="pages_financial_reporting_loan.php" class="nav-link">
                    <i class="fas fa-file-upload nav-icon"></i>
                    <p>Loans</p>
                  </a>
                </li>
            ...
            <li class="nav-item">
               <a href="login_status.php" class="nav-link">
              <i class="fas fa-user-cog nav-icon"></i>
              <p>Login Data</p>
              </a>
            </li>
