              ...
              <div class="card-body">
                <table id="example1" class="table table-hover table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    // Assuming $currentUser contains the user ID of the current user
                    $currentUser = 1; // Replace this with the actual user ID

                    // Query to fetch clients who haven't opened an account
