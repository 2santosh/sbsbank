                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class=" col-md-4 form-group">
                                                    ...
                                                    <input type="text" readonly name="receiving_acc_name" required class="form-control" id="ReceivingAcc">
                                                </div>
                                                <div class=" col-md-4 form-group">
                                                    <label for="exampleInputPassword1">Receiving Account Holder</label>
                                                    <input type="text"readonly name="receiving_acc_holder" required class="form-control" id="AccountHolder">
                                                </div>
