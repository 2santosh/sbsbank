...
$result_loans_amount = $mysqli->query("SELECT SUM(loan_amount) AS total_loans_amount FROM loans")->fetch_assoc()['total_loans_amount'];
$result_rateloans_amount = $mysqli->query("SELECT SUM(loan_amount) AS total_rateloans_amount FROM rateloans")->fetch_assoc()['total_rateloans_amount'];
$total_loan_amount = $result_loans_amount + $result_rateloans_amount;
?>
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed">
          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                 <div class="row">
                  <div class="col-md-6">
                    <div id="PieChart" style="height: 400px; max-width: 500px; margin: 0px auto;"></div>
                  </div>
                  <div class="col-md-6">
                    <div id="AccChart" style="height: 400px; max-width: 500px; margin: 0px auto;"></div>
                  </div>
              </div>
              <div class="row">
                <div class="col-md-12">
                  <div id="LoanChart" style="height: 400px; max-width: 500px; margin: 0px auto;"></div>
                </div>
              </div>
            ...
            <div class="card-footer">
              <div class="row">
                ...
                <div class="col-sm-3 col-6">
                  <div class="description-block">
                    <h5 class="description-header">$ <?php echo $result_loanpayments; ?> </h5>
                    <span class="description-text">TOTAL LOANS PAYMENTS</span>
                  </div>
                </div>
                <div class="col-sm-3 col-6">
                  <div class="description-block">
                    <h5 class="description-header">$ <?php echo $result_loan_dues; ?> </h5>
                    <span class="description-text">TOTAL LOANS DUE</span>
                  </div>
                </div>
                <!-- /.col -->
                <div class="col-sm-3 col-6">
                  <div class="description-block">
                    <h5 class="description-header">$ <?php echo $result_loans; ?> </h5>
                    <span class="description-text">TOTAT LOANS </span>
                  </div>
                  <!-- /.description-block -->
                </div>
          ...
          <div class="card-body p-0">
            <div class="table-responsive">
              <table class="table table-hover table-bordered table-striped m-0">
                ...
                <tbody>
                  <?php
                  // Get latest transactions including loan payments
                  $ret = "
                          SELECT tr_code, account_number, tr_type, transaction_amt, client_name, created_at
                          FROM (
                            SELECT tr_code, account_number, tr_type, transaction_amt, client_name, created_at
                            FROM `iB_Transactions`
                            UNION ALL
                            SELECT tr_code, borrower_national_id AS account_number, 'Loan Payment' AS tr_type, payment_amount AS transaction_amt, '' AS client_name, payment_date AS created_at
                            FROM `loanpayments`
  ...
  <script>
    window.onload = function() {
      ...
      var PieChart = new CanvasJS.Chart("PieChart", {
        ...
        data: [{
          ...
          dataPoints: [{
            ...
            {
              y: <?php echo $Retirement; ?>,
              name: "Retirement Acc"
            },
            {
              y: <?php echo $Recurring; ?>,
      ...
      var LoanChart = new CanvasJS.Chart("LoanChart", {
        exportEnabled: false,
        animationEnabled: true,
        title: {
          text: "Loans"
        ...
        data: [{
          ...
          indexLabel: "{name} - {y}%",
          dataPoints: [{
              y: <?php echo $result_loans; ?>,
              name: "Loans"
            },
            {
              y: <?php echo $result_rateloans; ?>,
              name: "Rate Loans"
            },
            {
              y: <?php echo $result_loanpayments; ?>,
              name: "Loan Payments"
            },
            {
              y: <?php echo $result_loan_dues; ?>,
              name: "Loan Dues"
            },
            {
              y: <?php echo $result_loans + $result_rateloans + $result_loanpayments + $result_loan_dues; ?>,
              name: "Total Loans"
            }
          ]
        }]
