...
if (isset($_POST['create_acc_type'])) {
    ...
    // Check if an account type with the same name already exists
    $check_query = "SELECT * FROM iB_Acc_types WHERE name = ?";
    ...
    if ($check_result->num_rows > 0) {
        $err = "An account type with the same name already exists.";
    } else {
