...
if (isset($_GET['RollBack_Transaction'])) {
  ...
  $check_stmt = $mysqli->prepare("SELECT tr_id FROM iB_Transactions WHERE tr_id = ?");
  ...
  if ($check_stmt->num_rows > 0) {
    ...
    $delete_stmt = $mysqli->prepare("DELETE FROM iB_Transactions WHERE tr_id = ?");
